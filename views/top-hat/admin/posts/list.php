...
<form class="form-inline" role="form" action="<?=$base_url?>">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="search" name="s" value="<?=$vars->s?>">
...
<table class="table table-striped table-bordered table-hover">
    ...
    foreach ($vars->posts as $post) { ?>
        ...
        <tr>
            ...
            <td class="actions"><button class="btn btn-default use-post btn-xs" data-post-id="<?=$post->id?>">Use</button></td>
        </tr>
